...
class PartitionAttentionModelTest(unittest.TestCase):
    ...
    def test_level_and_partition_shapes(self):
        ...
        image = torch.rand(1, 3, 448, 640)
        sparse_depth = torch.rand(1, 1, 448, 640)
    ...
    def test_forward_backward_and_checkpoint(self):
        ...
        # The only spatial convolutions are the seven initial level creators in
        # each input branch.
        convolution_names = [
            name
        ...
        self.assertEqual(len(convolution_names), 14)
        self.assertTrue(all(
